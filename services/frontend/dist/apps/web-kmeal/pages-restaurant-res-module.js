...
var ResComponent = /** @class */ (function () {
    ...
    ResComponent.prototype.ngOnInit = function () {
        this.breakpoint = this.generateBreakpoint(window.innerWidth);
    };
    ResComponent.prototype.onResize = function (event) {
        this.breakpoint = this.generateBreakpoint(event.target.innerWidth);
    };
    ResComponent.prototype.generateBreakpoint = function (width) {
        return (width <= 959) ? 1 : (width <= 1279) ? 2 : 3;
    };
    ResComponent.prototype.placeOrder = function (dish) {
    };
...
var dish_module_1 = __webpack_require__(/*! ../../features/shared/dish/dish.module */ "./src/app/features/shared/dish/dish.module.ts");
exports.routing = [
