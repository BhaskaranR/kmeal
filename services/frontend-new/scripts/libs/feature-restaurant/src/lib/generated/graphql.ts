...
// ====================================================
    ...
    export class KmealListingGQL extends Apollo.Query<KmealListing.Query, KmealListing.Variables> {
        document: any = gql`
    query kmeal_listing($menuBookWhere: kmeal_menu_book_bool_exp, $menuBookOrderby: [kmeal_menu_book_order_by!], $menuBookSectionsOrderby: [kmeal_menu_book_section_order_by!], $itemSectionsOrderby: [kmeal_item_section_order_by!], $listingWhere: kmeal_listing_bool_exp) {
