...
export const EXAMPLE_DATA: OrderBlotterItem[] = [
  ...
  { id: 21, name: "Nitrogen", status:'Requested' },
  { id: 22, name: "Oxygen",   status:'Requested' },
  { id: 23, name: "Fluorine", status:'Requested'},
  { id: 24, name: "Neon",     status:'Requested' },
  { id: 25, name: "Sodium" ,  status:'Requested'},
  { id: 26, name: "Magnesium",status:'Requested'},
  { id: 27, name: "Aluminum" ,status:'Requested'},
  { id: 28, name: "Silicon",  status:'Requested'},
  { id: 29, name: "Phosphorus",status:'Requested'},
  { id: 30, name: "Sulfur",   status:'Requested' },
  { id: 31, name: "Chlorine", status:'Requested' },
  { id: 32, name: "Argon",    status:'Requested' },
  { id: 33, name: "Potassium",status:'Requested' },
  { id: 34, name: "Calcium",  status:'Requested' }
];
