...
namespace kmeal {
    void kmeal::regpool( account_name account, uint8_t resource, uint64_t volume ) {
    ...
    void kmeal::add_total_volume( uint8_t resource, uint64_t volume, uint64_t u_volume ) {
        volume -= u_volume;
