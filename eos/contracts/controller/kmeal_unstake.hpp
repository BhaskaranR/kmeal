...
namespace kmeal {
    void kmeal::unstaking( account_name from, account_name to, uint64_t key, uint8_t resource ) {
        require_auth( from );
    ...
    void kmeal::subamount( account_name account, uint8_t resource, asset balance, uint64_t staking ) {
